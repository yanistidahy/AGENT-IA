...
describe("ce qui manque est nommé, jamais deviné", () => {
  const mail = { mailboxId: "mbx_principale", slug: "principale", label: "Boîte principale", user: "", fromName: "", from: "", host: "", port: 587, encryption: "starttls" as const, signName: "", signTitle: "", signPhone: "", demoLabel: "", demoUrl: "" };
